...
.on("click",function(){
  ...
  d3.json("labels.json",function(json){
    ...
    .data(json)
    .attr({
      fill : function(d){return colors[d[0]];}
    })
    d3.json("center2.json",function(i,json){
      ...
      .attr({
        ...
        r  : 6,
        opacity : 1,
        fill : function(d,i){return colors[1-i];},
        class : "centers",
        stroke : "black"
      })
    })
...
.on("click",function(){
  ...
  d3.json("labels.json",function(json){
    ...
    .data(json)
    .attr({
      fill : function(d){return colors[d[1]];}
    })
    d3.json("center3.json",function(i,json){
      ...
      .attr({
        ...
        r  : 6,
        opacity : 1,
        fill : function(d,i){return colors[2-i];},
        class : "centers",
        stroke : "black"
      })
    })
...
.on("click",function(){
  ...
  d3.json("labels.json",function(json){
    ...
    .data(json)
    .attr({
      fill : function(d){return colors[d[2]];}
    })
    d3.json("center4.json",function(i,json){
      ...
      .attr({
        ...
        r  : 6,
        opacity : 1,
        fill : function(d,i){return colors[3-i];},
        class : "centers",
        stroke : "black"
      })
    })
...
.on("click",function(){
  ...
  d3.json("labels.json",function(json){
    ...
    .data(json)
    .attr({
      fill : function(d){return colors[d[3]];}
    })
    d3.json("center5.json",function(i,json){
      ...
      .attr({
        ...
        r  : 6,
        opacity : 1,
        fill : function(d,i){return colors[4-i];},
        class : "centers",
        stroke : "black"
      })
    })
...
.on("click",function(){
  ...
  d3.json("labels.json",function(json){
    ...
    .data(json)
    .attr({
      fill : function(d){return colors[d[4]];}
    })
    d3.json("center6.json",function(i,json){
      ...
      .attr({
        ...
        r  : 6,
        opacity : 1,
        fill : function(d,i){return colors[5-i];},
        class : "centers",
        stroke : "black"
      })
    })
